...
const updateApplicationEval: EvalFunction = {
  ...
  run: async () => {
    const result = await grade(openai("gpt-4"), "Update the 'test-app' ArgoCD application to point to the 'main' branch instead of 'master'.");
    return JSON.parse(result);
  }
};
...
const getApplicationResourceTreeEval: EvalFunction = {
  ...
  description: 'Evaluates the model\'s ability to retrieve the resource tree for an ArgoCD application',
  run: async () => {
    const result = await grade(openai("gpt-4"), "Show me the resource tree for the 'my-app' application in ArgoCD.");
    return JSON.parse(result);
  }
};
...
const getApplicationManagedResourcesEval: EvalFunction = {
  ...
  description: 'Evaluates the model\'s ability to retrieve managed resources for an ArgoCD application',
  run: async () => {
    const result = await grade(openai("gpt-4"), "What resources are managed by the 'my-app' application in ArgoCD?");
    return JSON.parse(result);
  }
};
...
const getApplicationWorkloadLogsEval: EvalFunction = {
  ...
  run: async () => {
    const result = await grade(openai("gpt-4"), "Show me the logs for the 'web' deployment in the 'my-app' application.");
    return JSON.parse(result);
  }
};
...
const getApplicationEventsEval: EvalFunction = {
  ...
  run: async () => {
    const result = await grade(openai("gpt-4"), "What events have occurred for the 'my-app' application in ArgoCD?");
    return JSON.parse(result);
  }
};
...
const getResourceEventsEval: EvalFunction = {
  ...
  description: 'Evaluates the model\'s ability to retrieve events for a resource within an ArgoCD application',
  run: async () => {
    const result = await grade(openai("gpt-4"), "Show me the events for the 'web' deployment in the 'my-app' application.");
    return JSON.parse(result);
  }
};
...
const getResourceActionsEval: EvalFunction = {
  ...
  run: async () => {
    const result = await grade(openai("gpt-4"), "What actions can I perform on the 'database' StatefulSet in the 'my-app' application?");
    return JSON.parse(result);
  }
};
...
const runResourceActionEval: EvalFunction = {
  ...
  run: async () => {
    const result = await grade(openai("gpt-4"), "Restart the 'web' deployment in the 'my-app' application.");
    return JSON.parse(result);
  }
};
